    ...
    <div class="tp-header-space-2">
        <div class="container-fluid">
            <div class="row align-items-center">
                ...
                <div class="col-6 col-lg-2">
                    <a style="margin-top: 60px; background-color: cadetblue; font-weight: bolder; width: 100px" href="#" class="login_btn btn btn-sm text-white" data-bs-toggle="modal" data-bs-target="#exampleModal">
                        Login
                    </a>
                    <div class="tp-header-main-right-2 d-flex align-items-center justify-content-xl-end">
                        ...
                        <div style="margin-right: -50px" class="tp-header-main-right-hamburger-btn d-xl-none offcanvas-open-btn">
