                ...
                <div class="block-content">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 space-y-2">
                            ...
                            <form class="row row-cols-lg-auto g-3 align-items-center" action="{{ route('user.storeInternalTransfer') }}" method="POST" >
                                @csrf
                                @if ($errors->any())
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="col-lg-6 offset-lg-2 mb-3">
                                        <p></p>
                                        <p>Please contact customer care if you don't have your NSB Code
